...
json_filepath = os.path.join(current_directory, "_ImportWeaponTextTable.json")
data = load_json_data(json_filepath)

# Assuming data and weapon_counts are defined as before
output_file_path = 'F:\SteamLibrary\steamapps\common\EARTH DEFENSE FORCE 5\Mods\DEFAULTPACKAGE\output_file.txt'  # Update this to your desired file path
